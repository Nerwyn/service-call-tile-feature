		...
		`}static get styles(){return[super.styles,r.css`
			...
			`]}};t.ServiceCallSlider=c,i([(0,o.state)()],c.prototype,"showTooltip",void 0),i([(0,o.state)()],c.prototype,"sliderOn",void 0),i([(0,o.state)()],c.prototype,"currentValue",void 0),t.ServiceCallSlider=c=i([(0,o.customElement)("service-call-slider")],c)},682:function(e,t,n){"use strict";var i=this&&this.__decorate||function(e,t,n,i){var r,o=arguments.length,s=o<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,n,s):r(t,n))||s);return o>3&&s&&Object.defineProperty(t,n,s),s};Object.defineProperty(t,"__esModule",{value:!0}),t.ServiceCallSpinbox=void 0;const r=n(814),o=n(595),s=n(921),a=n(839),l=n(393);n(827);let c=class extends l.BaseServiceCallFeature{constructor(){super(...arguments),this.range=[-32768,32767],this.step=1,this.debounceTime=1e3}onStart(e){this.swiping=!1,"targetTouches"in e?(this.initialX=e.targetTouches[0].clientX,this.initialY=e.targetTouches[0].clientY):(this.initialX=e.clientX,this.initialY=e.clientY)}onEnd(e){if(clearTimeout(this.debounceTimer),!this.swiping){const t=e.currentTarget.id;clearTimeout(this.getValueFromHassTimer),this.getValueFromHass=!1;const n=parseFloat(this.value);let i=this.value;switch(t){case"increment":i=n+this.step;break;case"decrement":i=n-this.step}this.value=Math.min(Math.max(i,this.range[0]),this.range[1]),this.debounceTimer=setTimeout((()=>{this.sendAction("tap_action"),this.resetGetValueFromHass()}),this.debounceTime)}this.endAction()}onMove(e){var t,n;let i,r;"targetTouches"in e?(i=e.targetTouches[0].clientX,r=e.targetTouches[0].clientY):(i=e.clientX,r=e.clientY);const o=(null!==(t=this.initialX)&&void 0!==t?t:i)-i,s=(null!==(n=this.initialY)&&void 0!==n?n:r)-r;Math.abs(Math.abs(o)-Math.abs(s))>8&&(this.endAction(),clearTimeout(this.debounceTimer),this.swiping=!0)}buildButton(e){var t,n,i,o,l,c,u,h,p,f,d,m,v,y,_,g,b;const w=null!==(t=this.entry[e])&&void 0!==t?t:{};return"icon"in w||(w.icon="increment"==e?"mdi:plus":"mdi:minus"),"none"==(0,a.renderTemplate)(this.hass,null!==(i=null===(n=null==w?void 0:w.tap_action)||void 0===n?void 0:n.action)&&void 0!==i?i:"none")&&"none"==(0,a.renderTemplate)(this.hass,null!==(l=null===(o=null==w?void 0:w.double_tap_action)||void 0===o?void 0:o.action)&&void 0!==l?l:"none")&&["none","repeat"].includes((0,a.renderTemplate)(this.hass,null!==(u=null===(c=null==w?void 0:w.hold_action)||void 0===c?void 0:c.action)&&void 0!==u?u:"none"))&&"none"==(0,a.renderTemplate)(this.hass,null!==(p=null===(h=null==w?void 0:w.momentary_start_action)||void 0===h?void 0:h.action)&&void 0!==p?p:"none")&&"none"==(0,a.renderTemplate)(this.hass,null!==(d=null===(f=null==w?void 0:w.momentary_end_action)||void 0===f?void 0:f.action)&&void 0!==d?d:"none")?r.html`
				<button
					...
					@touchmove=${this.onTouchMove}
					@contextmenu=${this.onContextMenu}
					style=${(0,s.styleMap)(this.buildStyle(null!==(b=null!==(_=null===(y=this.entry[e])||void 0===y?void 0:y.background_style)&&void 0!==_?_:null===(g=this.entry[e])||void 0===g?void 0:g.style)&&void 0!==b?b:{}))}
				>
					${this.buildIcon(this.entry[e])}
					${this.buildLabel(this.entry[e])}
				</button>
			`:("label_style"in w||(w.label_style={}),"font-size"in w.label_style||(w.label_style["font-size"]="14px"),"font-weight"in w.label_style||(w.label_style["font-weight"]="500"),"opacity"in w.label_style||(w.label_style.opacity="0.77"),r.html`
				<service-call-button
					id=${e}
					.hass=${this.hass}
					.entry=${w}
					._shouldRenderRipple=${!1}
					@contextMenu=${this.onContextMenu}
					style=${(0,s.styleMap)(this.buildStyle(null!==(v=null===(m=this.entry[e])||void 0===m?void 0:m.style)&&void 0!==v?v:{}))}
				/>
