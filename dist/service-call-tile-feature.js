...
(()=>{"use strict";var t={393:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.BaseServiceCallFeature=void 0;const r=i(677),n=i(595),o=i(921);let l=class extends r.LitElement{constructor(){super(),this.value=0}setValueInStyleFields(t){if(t){if(t.includes("VALUE")){if(!this.value)return"";t=t.replace("VALUE",this.value.toString())}if(t.includes("STATE")){const e=this.hass.states[this.entity_id].state;t=t.replace("STATE",e)}const e=/ATTRIBUTE\[(.*?)\]/gm;let i;for(;null!=(i=e.exec(t));){const e=i[1];let s=this.hass.states[this.entity_id].attributes[e];switch(e){case"brightness":if(!s)return"0";s=Math.round(parseInt(null!=s?s:0)/255*100).toString();break;case"rgb_color":s=Array.isArray(s)&&3==s.length?`rgb(${s[0]}, ${s[1]}, ${s[2]})`:"var(--primary-text-color)";break;default:if(null==s||null==s)return}t=t.replace(`ATTRIBUTE[${i[1]}]`,s)}return t}return""}render(){var t;Array.isArray(this.entry.data.entity_id)?this.entity_id=this.entry.data.entity_id[0]:this.entity_id=null!==(t=this.entry.data.entity_id)&&void 0!==t?t:"";const e=this.entry.value_attribute;if("state"==e)this.value=this.hass.states[this.entity_id].state;else{let t=this.hass.states[this.entity_id].attributes[e];"brightness"==e&&(t=Math.round(parseInt(null!=t?t:0)/255*100)),this.value=t}let i=r.html``;if("icon"in this.entry){const t={};this.entry.icon_color&&(t.color=this.setValueInStyleFields(this.entry.icon_color)),i=r.html`<ha-icon
		...
		></button>`;return r.html`${i}${t}`}static get styles(){return[super.styles,r.css`
			...
			`]}};e.ServiceCallButton=a,e.ServiceCallButton=a=s([(0,n.customElement)("service-call-button")],a)},719:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.ServiceCallSlider=void 0;const r=i(677),n=i(595),o=i(921),l=i(393);let a=class extends l.BaseServiceCallFeature{constructor(){super(),this.step=1}onInput(t){var e,i,s;t.preventDefault(),t.stopImmediatePropagation();const r=t.currentTarget,n=null!==(i=null!==(e=this.oldValue)&&void 0!==e?e:this.value)&&void 0!==i?i:0,o=parseFloat(null!==(s=r.value)&&void 0!==s?s:n);r.value=n.toString(),this.newValue=o;let l=n;if(n>o){const t=setInterval((()=>{l-=this.step,r.value=l.toString(),o>=l&&(clearInterval(t),r.value=o.toString())}),1)}else if(n<o){const t=setInterval((()=>{l+=this.step,r.value=l.toString(),o<=l&&(clearInterval(t),r.value=o.toString())}),1)}else r.value=o.toString();this.oldValue=o}onEnd(t){const[e,i]=this.entry.service.split("."),s=JSON.parse(JSON.stringify(this.entry.data));for(const t in s)s[t].toString().includes("VALUE")&&(s[t]=s[t].toString().replace("VALUE",this.newValue));this.hass.callService(e,i,s),this.value=this.newValue}render(){var t;const e=super.render(),i={};this.entry.background_color&&(i.background=this.setValueInStyleFields(this.entry.background_color)),(this.entry.background_opacity||0==this.entry.background_opacity)&&(i.opacity=this.entry.background_opacity);const s=r.html`<div
