...
(()=>{"use strict";var t={393:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.BaseServiceCallFeature=void 0;const r=i(677),n=i(595),o=i(921);let l=class extends r.LitElement{constructor(){super(),this.value=0}setValueInStyleFields(t){if(t){if(t.includes("VALUE")&&(t=t.replace("VALUE",this.value.toString())),t.includes("STATE")){const e=this.hass.states[this.entity_id].state;t=t.replace("STATE",e)}const e=/ATTRIBUTE\[(.*?)\]/gm;let i;for(;null!=(i=e.exec(t));){let e=this.hass.states[this.entity_id].attributes[i[1]];"brightness"==i[1]&&(e=Math.round(parseInt(e)/255*100)),t=t.replace(`ATTRIBUTE[${i[1]}]`,e)}return t}return""}render(){var t;Array.isArray(this.entry.data.entity_id)?this.entity_id=this.entry.data.entity_id[0]:this.entity_id=null!==(t=this.entry.data.entity_id)&&void 0!==t?t:"";const e=this.entry.value_attribute;if("state"==e)this.value=this.hass.states[this.entity_id].state;else{let t=this.hass.states[this.entity_id].attributes[e];"brightness"==e&&(t=Math.round(parseInt(t)/255*100)),this.value=t}let i=r.html``;if("icon"in this.entry){const t={color:this.setValueInStyleFields(this.entry.icon_color)};i=r.html`<ha-icon
		...
		></button>`;return r.html`${s}${e}`}static get styles(){return[super.styles,r.css`
			...
			`]}};e.ServiceCallButton=a,e.ServiceCallButton=a=s([(0,n.customElement)("service-call-button")],a)},719:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.ServiceCallSlider=void 0;const r=i(677),n=i(595),o=i(921),l=i(393);let a=class extends l.BaseServiceCallFeature{constructor(){super(),this.inputEnd=!0,this.step=1}onInput(t){var e,i;this.inputEnd=!1,t.preventDefault(),t.stopImmediatePropagation();const s=t.currentTarget,r=null!==(e=this.oldValue)&&void 0!==e?e:0,n=parseInt(null!==(i=s.value)&&void 0!==i?i:r);this.value=n,s.value=r.toString();let o=r;if(r>n){const t=setInterval((()=>{o-=this.step,s.value=o.toString(),n>=o&&(clearInterval(t),s.value=n.toString(),this.inputEnd=!0)}),1)}else if(r<n){const t=setInterval((()=>{o+=this.step,s.value=o.toString(),n<=o&&(clearInterval(t),s.value=n.toString(),this.inputEnd=!0)}),1)}this.oldValue=n}onEnd(t){const[e,i]=this.entry.service.split("."),s=JSON.parse(JSON.stringify(this.entry.data));for(const t in s)s[t].toString().includes("VALUE")&&(s[t]=s[t].toString().replace("VALUE",this.value));this.hass.callService(e,i,s)}render(){var t;const e=super.render(),i={background:this.setValueInStyleFields(this.entry.background_color),opacity:parseInt(this.setValueInStyleFields(null===(t=this.entry.background_opacity)||void 0===t?void 0:t.toString()))},s=r.html`<div
