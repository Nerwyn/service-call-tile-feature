...
(()=>{"use strict";var t={393:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.BaseServiceCallFeature=void 0;const r=i(677),n=i(595),o=i(921);let l=class extends r.LitElement{constructor(){super(),this.value=0}setValueInStyleFields(t){if(t){if(t.includes("VALUE")&&(t=t.replace("VALUE",this.value.toString())),t.includes("STATE")){const e=this.hass.states[this.entity_id].state;t=t.replace("STATE",e)}const e=/ATTRIBUTE\[(.*?)\]/gm;let i;for(;null!=(i=e.exec(t));){const e=i[1];let s=this.hass.states[this.entity_id].attributes[e];switch(e){case"brightness":s=Math.round(parseInt(null!=s?s:0)/255*100);break;case"color":case"rgb_color":s=Array.isArray(s)&&3==s.length?`rgb(${s[0]}, ${s[1]}, ${s[2]})`:"var(--primary-text-color)"}t=t.replace(`ATTRIBUTE[${i[1]}]`,s)}return t}return""}render(){var t;Array.isArray(this.entry.data.entity_id)?this.entity_id=this.entry.data.entity_id[0]:this.entity_id=null!==(t=this.entry.data.entity_id)&&void 0!==t?t:"";const e=this.entry.value_attribute;if("state"==e)this.value=this.hass.states[this.entity_id].state;else{let t=this.hass.states[this.entity_id].attributes[e];"brightness"==e&&(t=Math.round(parseInt(t)/255*100)),this.value=t}let i=r.html``;if("icon"in this.entry){const t={color:this.setValueInStyleFields(this.entry.icon_color)};i=r.html`<ha-icon
		...
		></div>`;let[l,a]=[0,100];this.entry.range&&([l,a]=this.entry.range),this.step=(a-l)/50;let c="slider";c="line"===this.entry.thumb?"slider-line-thumb":"slider";const h=r.html`
			<input
				...
				@touchend=${this.onEnd}
			/>
		`,d={"--slider-color":this.setValueInStyleFields(this.entry.color),opacity:parseInt(this.setValueInStyleFields(null===(e=this.entry.opacity)||void 0===e?void 0:e.toString()))};return r.html`<div class="container" style=${(0,o.styleMap)(d)}>
			${n}${h}${i}
