...
(()=>{"use strict";var t={393:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.BaseServiceCallFeature=void 0;const r=i(677),n=i(595),o=i(921);let l=class extends r.LitElement{constructor(){super(),this.value=0}set hass(t){var e,i,s,r,n;(null===(e=this.entry.data)||void 0===e?void 0:e.entity_id)&&(Array.isArray(null===(i=this.entry.data)||void 0===i?void 0:i.entity_id)?this.entity_id=null===(s=this.entry.data)||void 0===s?void 0:s.entity_id[0]:this.entity_id=null!==(n=null===(r=this.entry.data)||void 0===r?void 0:r.entity_id)&&void 0!==n?n:"",this.entry.value_attribute&&("state"==this.entry.value_attribute?this.value=t.states[this.entity_id].state:this.value=t.states[this.entity_id].attributes[this.entry.value_attribute]))}setLabelToValue(t,e){var i;"label"in this.entry&&(null===(i=this.entry.label)||void 0===i?void 0:i.includes("VALUE"))&&("icon"in this.entry?t.nextElementSibling.nextElementSibling.innerHTML=this.entry.label.replace("VALUE",e):t.nextElementSibling.innerHTML=this.entry.label.replace("VALUE",e))}render(){let t=r.html``;if("icon"in this.entry){const e={color:this.entry.icon_color};t=r.html`<ha-icon
