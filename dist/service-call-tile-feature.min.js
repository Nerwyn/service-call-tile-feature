		...
		></div>`;switch(this.class="slider",(0,a.renderTemplate)(this.hass,this.entry.thumb)){case"line":this.class="slider-line-thumb";break;case"flat":this.class="slider-flat-thumb";break;default:this.class="slider"}(null==this.value||this.value==this.range[0]&&"slider-line-thumb"!=this.class)&&(this.class="slider-off");const f=structuredClone(null!==(n=this.entry.slider_style)&&void 0!==n?n:{});for(const e in f)f[e]=(0,a.renderTemplate)(this.hass,f[e]);let d;return d=this.touchscreen?r.html`
			...
			`:r.html`
				<input
					...
					@mousemove=${this.onHoldMove}
				/>
			`,r.html`${p}${d}${i}`}static get styles(){return[super.styles,r.css`
				:host {
					--color: var(--tile-color);
