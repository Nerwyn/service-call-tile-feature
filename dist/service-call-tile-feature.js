...
(()=>{"use strict";var t={393:function(t,e,i){var s=this&&this.__decorate||function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o};Object.defineProperty(e,"__esModule",{value:!0}),e.BaseServiceCallFeature=void 0;const r=i(677),n=i(595),o=i(921);let l=class extends r.LitElement{constructor(){super(),this.value=0}setLabelToValue(t,e){var i;"label"in this.entry&&(null===(i=this.entry.label)||void 0===i?void 0:i.includes("VALUE"))&&("icon"in this.entry?t.nextElementSibling.nextElementSibling.innerHTML=this.entry.label.replace("VALUE",e):t.nextElementSibling.innerHTML=this.entry.label.replace("VALUE",e))}render(){var t;Array.isArray(this.entry.data.entity_id)?this.entity_id=this.entry.data.entity_id[0]:this.entity_id=null!==(t=this.entry.data.entity_id)&&void 0!==t?t:"";const e=this.entry.value_attribute;if("state"==e)this.value=this.hass.states[this.entity_id].state;else{let t=this.hass.states[this.entity_id].attributes[e];"brightness"==e&&(t=Math.round(parseInt(t)/255*100)),this.value=t}let i=r.html``;if("icon"in this.entry){const t={color:this.entry.icon_color};i=r.html`<ha-icon
			...
			></ha-icon>`}let s=r.html``;if("label"in this.entry){let t=this.entry.label;if(t.includes("VALUE")&&(t=t.replace("VALUE",this.value.toString())),t.includes("STATE")){const e=this.hass.states[this.entity_id].state;t=t.replace("STATE",e)}const e=/ATTRIBUTE\[(.*?)\]/gm;let i;for(;null!=(i=e.exec(t));){let e=this.hass.states[this.entity_id].attributes[i[1]];"brightness"==i[1]&&(e=Math.round(parseInt(e)/255*100)),t=t.replace(`ATTRIBUTE[${i[1]}]`,e)}const n={color:this.entry.label_color};s=r.html`<div class="label" style="${(0,o.styleMap)(n)}">${t}</div>`}return r.html`${i}${s}`}static get styles(){return[r.css`
				:host {
					display: flex;
					flex-flow: column;
