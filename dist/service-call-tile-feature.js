...
(()=>{"use strict";var __webpack_modules__={393:function(__unused_webpack_module,exports,__webpack_require__){var __decorate=this&&this.__decorate||function(e,t,i,r){var s,n=arguments.length,o=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,r);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(exports,"__esModule",{value:!0}),exports.BaseServiceCallFeature=void 0;const lit_1=__webpack_require__(677),decorators_js_1=__webpack_require__(595),style_map_js_1=__webpack_require__(921);let BaseServiceCallFeature=class BaseServiceCallFeature extends lit_1.LitElement{constructor(){super(...arguments),this.value=0}setTemplates(entry){if("object"==typeof entry&&null!=entry){for(const e in entry)entry[e]=this.setTemplates(entry[e]);return entry}if("string"==typeof entry&&(entry.includes("{{")||entry.includes("{%"))){const hass=this.hass,VALUE=this.value,config={entity:this.entry.entity_id};function states(e){return hass.states[e].state}function is_state(e,t){return states(e)==t}function state_attr(e,t){return hass.states[e].attributes[t]}function is_state_attr(e,t,i){return state_attr(e,t)==i}function has_value(e){try{const t=states(e);return!![!1,0,-0,""].includes(t)||Boolean(t)}catch(e){return!1}}const templates=entry.match(/{{(.|\n)*?}}/gm);if(templates)for(const template of templates){const code=template.replace(/{{|}}|\n/gm,"").trim();let executed;try{executed=eval(code),entry=null!=executed||null!=executed?entry.replace(template,executed).trim():""}catch(t){console.error(`Error evaluating ${template}:\n${t}`),executed=void 0}}}return null!=entry&&null!=entry||(entry=""),entry}setValueInStyleFields(e){if(e){if(e.includes("VALUE")){if(!this.value)return"";e=e.replace(/VALUE/g,this.value.toString())}if(e.includes("STATE")){const t=this.hass.states[this.entry.entity_id].state;e=e.replace(/STATE/g,t)}const t=/ATTRIBUTE\[(.*?)\]/g,i=e.match(t);if(i){for(const t of i){const i=t.replace("ATTRIBUTE[","").replace("]","");let r=this.hass.states[this.entry.entity_id].attributes[i];switch(i){case"brightness":if(!r)return"0";r=Math.round(parseInt(null!=r?r:0)/255*100).toString();break;case"rgb_color":r=Array.isArray(r)&&3==r.length?`rgb(${r[0]}, ${r[1]}, ${r[2]})`:"var(--primary-text-color)";break;default:if(null==r||null==r)return}e=e.replace(`ATTRIBUTE[${i}]`,r)}return e}return e}return""}callService(){if("confirmation"in this.evalEntry&&0!=this.evalEntry.confirmation){let e=`Are you sure you want to run action '${this.evalEntry.service}'?`;if(1==this.evalEntry.confirmation){if(!confirm(e))return}else if("text"in this.evalEntry.confirmation&&(e=this.setValueInStyleFields(this.evalEntry.confirmation.text)),"exemptions"in this.evalEntry.confirmation){if(!this.evalEntry.confirmation.exemptions.map((e=>e.user)).includes(this.hass.user.id)&&!confirm(e))return}else if(!confirm(e))return}if("service"in this.evalEntry){const[e,t]=this.evalEntry.service.split("."),i=JSON.parse(JSON.stringify(this.evalEntry.data));for(const e in i)"VALUE"==i[e]?i[e]=this.value:i[e].toString().includes("VALUE")&&(i[e]=i[e].toString().replace("VALUE",this.value));this.hass.callService(e,t,i)}}render(){this.evalEntry=this.setTemplates(JSON.parse(JSON.stringify(this.entry)));const e=this.evalEntry.value_attribute;if("state"==e)this.value=this.hass.states[this.evalEntry.entity_id].state;else{let t=this.hass.states[this.evalEntry.entity_id].attributes[e];"brightness"==e&&(t=Math.round(parseInt(null!=t?t:0)/255*100)),this.value=t}let t=lit_1.html``;if("icon"in this.evalEntry){const e={};this.evalEntry.icon_color&&(e.color=this.setValueInStyleFields(this.evalEntry.icon_color)),t=lit_1.html`<ha-icon
				.icon=${this.setValueInStyleFields(this.evalEntry.icon)}
				style="${(0,style_map_js_1.styleMap)(e)}"
			></ha-icon>`}let i=lit_1.html``;if("label"in this.evalEntry){const e=this.setValueInStyleFields(this.evalEntry.label);if(e){const t={};this.evalEntry.label_color&&(t.color=this.setValueInStyleFields(this.evalEntry.label_color)),i=lit_1.html`<div class="label" style="${(0,style_map_js_1.styleMap)(t)}">${e}</div>`}}return lit_1.html`${t}${i}`}static get styles(){return[lit_1.css`
				:host {
					display: flex;
					flex-flow: column;
			...
			`]}};exports.BaseServiceCallFeature=BaseServiceCallFeature,__decorate([(0,decorators_js_1.property)({attribute:!1})],BaseServiceCallFeature.prototype,"hass",void 0),__decorate([(0,decorators_js_1.property)({attribute:!1})],BaseServiceCallFeature.prototype,"entry",void 0),exports.BaseServiceCallFeature=BaseServiceCallFeature=__decorate([(0,decorators_js_1.customElement)("base-service-call-feature")],BaseServiceCallFeature)},827:function(e,t,i){var r=this&&this.__decorate||function(e,t,i,r){var s,n=arguments.length,o=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,r);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(t,"__esModule",{value:!0}),t.ServiceCallButton=void 0;const s=i(677),n=i(595),o=i(921),l=i(393);let a=class extends l.BaseServiceCallFeature{onClick(e){this.callService()}render(){const e=super.render(),t={};this.evalEntry.color&&(t["background-color"]=this.setValueInStyleFields(this.evalEntry.color)),(this.evalEntry.opacity||0==this.evalEntry.opacity)&&(t.opacity=this.evalEntry.opacity);const i=s.html`<button
			class="button"
			@click=${this.onClick}
		...
		></div>`;switch(this.class="slider",this.evalEntry.thumb){case"line":this.class="slider-line-thumb";break;case"flat":this.class="slider-flat-thumb";break;default:this.class="slider"}(null==this.value||0==this.value&&"slider-line-thumb"!=this.class)&&(this.class="slider-off");const l=s.html`
			<input
				...
				@touchend=${this.onEnd}
			/>
		`,a={};return this.evalEntry.color&&(a["--slider-color"]=this.setValueInStyleFields(this.evalEntry.color)),(this.evalEntry.opacity||0==this.evalEntry.opacity)&&(a["--slider-opacity"]=null===(e=this.evalEntry.opacity)||void 0===e?void 0:e.toString()),s.html`<div class="container" style=${(0,o.styleMap)(a)}>
			${n}${l}${t}
		</div>`}static get styles(){return[super.styles,s.css`
				:host {
					--slider-opacity: 1;
			...
			`]}};t.ServiceCallSlider=a,t.ServiceCallSlider=a=r([(0,n.customElement)("service-call-slider")],a)},114:function(e,t,i){var r=this&&this.__decorate||function(e,t,i,r){var s,n=arguments.length,o=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,r);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(t,"__esModule",{value:!0});const s=i(147),n=i(677),o=i(595),l=i(921);i(827),i(719),i(369),console.info(`%c SERVICE-CALL-TILE-FEATURE v${s.version}`,"color: white; font-weight: bold; background: cornflowerblue");class a extends n.LitElement{constructor(){super()}static getStubConfig(){return{type:"custom:service-call",entries:[{type:"button"}]}}setConfig(e){var t;if(!e)throw new Error("Invalid configuration");"buttons"in(e=JSON.parse(JSON.stringify(e)))&&!("entries"in e)&&(e.entries=e.buttons);for(let i of e.entries){i=this.updateDeprecatedEntryFields(i);for(let e of null!==(t=i.options)&&void 0!==t?t:[])e=this.updateDeprecatedEntryFields(e)}this.config=e}render(){var e,t,i;if(!this.config||!this.hass||!this.stateObj)return null;const r=[];for(let s of this.config.entries){if(null===(e=s.autofill_entity_id)||void 0===e||e){s=this.populateMissingEntityId(s,this.stateObj.entity_id);for(let e of null!==(t=s.options)&&void 0!==t?t:[])e=this.populateMissingEntityId(e,s.entity_id)}const o={};switch("flex_basis"in s&&(o["flex-basis"]=s.flex_basis),(null!==(i=s.type)&&void 0!==i?i:"button").toLowerCase()){case"slider":r.push(n.html`<service-call-slider
							.hass=${this.hass}
							.entry=${s}
						...
						/>`);break;default:r.push(n.html`<service-call-button
							...
							.entry=${s}
							style=${(0,l.styleMap)(o)}
						/>`)}}return n.html`<div class="row">${r}</div>`}updateDeprecatedEntryFields(e){var t,i;return e.data=Object.assign(Object.assign({},e.data||{}),e.target||{}),e.type=(null!==(t=e.type)&&void 0!==t?t:"button").toLowerCase(),e.value_attribute=(null!==(i=e.value_attribute)&&void 0!==i?i:"state").toLowerCase(),e}populateMissingEntityId(e,t){var i,r,s;return"entity_id"in e.data||"device_id"in e.data||"area_id"in e.data||(e.data.entity_id=null!==(i=e.entity_id)&&void 0!==i?i:t),"entity_id"in e||(e.entity_id=null!==(s=null===(r=e.data)||void 0===r?void 0:r.entity_id)&&void 0!==s?s:t),e}static get styles(){return n.css`
			.row {
				display: flex;
				flex-flow: row;
				justify-content: center;
